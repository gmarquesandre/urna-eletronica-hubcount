...
namespace ProjetoUrna.WebAPI.Migrations
{
    ...
    [Migration("20201212044705_add_tabela_join")]
    partial class add_tabela_join
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProjetoUrna.WebAPI.Models.VotoCandidato", b =>
                {
                    b.Property<string>("CodigoVoto");

                    b.Property<int>("IdCandidato");

                    b.HasKey("CodigoVoto", "IdCandidato");

                    b.HasIndex("IdCandidato");

                    b.ToTable("VotosCandidatos");
                });

            modelBuilder.Entity("ProjetoUrna.WebAPI.Models.VotoCandidato", b =>
                {
                    b.HasOne("ProjetoUrna.WebAPI.Models.Voto", "Votos")
                        .WithMany("VotosCandidatos")
                        .HasForeignKey("CodigoVoto")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("ProjetoUrna.WebAPI.Models.Candidato", "Batalhas")
                        .WithMany("VotosCandidatos")
